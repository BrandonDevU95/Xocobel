export default function MainBanner() {
   return (
      <section className="main-banner-corporate">
         <div className="main-banner-corporate_banner">
            <div className="main-banner-corporate_banner-container container">
               <div className="main-banner-corporate_banner-container_row row">
                  <div className="main-banner-corporate_banner-container_row-col col-12 col-lg-8 col-xl-6">
